...
import kr.app.binbang.SearchActivity;
 ...
 */
public class BangSearchApt extends BaseAdapter {
    ...
    public BangSearchApt(Context context, ArrayList<BangDataInfo> objects) {
        ...
        viewHolder.btn_img_favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if( mItemList.get(pos).getIs_favorite().equals("1") ){
                    ...
                    mItemList.get(pos).setIs_favorite("0");
                    SearchActivity.mAdapter.notifyDataSetChanged();

                    //최근 살펴본방 갱신
                    for(int i=0; i<MainFragment_1.mBang_array_recently.size(); i++) {
                        if (MainFragment_1.mBang_array_recently.get(i).get_id().equals(mItemList.get(pos).get_id())) {
                            MainFragment_1.mBang_array_recently.get(i).setIs_favorite("0");
                            MainFragment_1.mListAdapter_recently.notifyDataSetChanged();
                        }
                    }
/*                    for(int i=0; i<MainFragment_2.mBang_array_favorite.size(); i++) {
                        if (MainFragment_2.mBang_array_favorite.get(i).get_id().equals(mItemList.get(pos).get_id())) {
                            MainFragment_2.mBang_array_favorite.remove(i);
...
/*                    for(int i=0; i< MainFragment_2.mBang_array_favorite.size(); i++) {
                        if (MainFragment_2.mBang_array_favorite.get(i).get_id().equals(mItemList.get(pos).get_id())) {
                            MainFragment_2.mBang_array_favorite.add(0,mItemList.get(pos));
                            MainFragment_2.mListAdapter_favorite.notifyDataSetChanged();
                        }
                    }*/
                }
        ...
        if( mItemList.get(pos).getIs_favorite().equals("1") )
            ...
            viewHolder.btn_img_favorite.setImageResource(R.mipmap.list_favorite_off);

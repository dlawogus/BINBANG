...
import kr.app.binbang.MainSearchActivity;
 ...
 */
public class BangMainSearchApt extends BaseAdapter {
    ...
    public BangMainSearchApt(Context context, ArrayList<BangDataInfo> objects) {
        ...
        viewHolder.btn_img_call_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if( !mItemList.get(pos).getIs_calllay_open() ) {
                    ...
                    MainSearchActivity.mListAdapter.notifyDataSetChanged();
                }else{

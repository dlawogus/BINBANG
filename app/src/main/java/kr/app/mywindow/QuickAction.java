...
public class QuickAction extends PopupWindows implements OnDismissListener {
    ...
    public  void changActionItem(String title,int index){
        TextView m = (TextView)mTrack.getChildAt(index).findViewById(R.id.tv_title);
        m.setText(title);
    }
    /**
     * Add action item
    ...
    public void addActionItem(ActionItem action) {
        ...
        text.setTypeface(MainActivity.mTypeface);

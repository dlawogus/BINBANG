<?php
	...
	*/
	...
	$que = "SELECT * FROM binbang, building WHERE building.b_id=binbang.building_id AND (building.building_name like '%".$QUERY."%' OR building.juso like '%".$QUERY."%') Order by ".$ORDERBY." Limit ".($pageNum*($PAGE-1)).",".$pageNum.";";

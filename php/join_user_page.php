...
<head>
	...
	function join(frmList){
		...
		document.frmList.action = "join_user.php";
...
<div class="container">
	<p align='center'>
		<button type="button" onclick="#" style="color:white ; background-color:black ; width:20%" >대표님 회원가입</button>
		<button type="button" onclick="location.href='join_user2_page.php'"  style="color:black ; background-color:white ; width:20%" >직원회원가입</button>
	</p>
	<div class="panel panel-default">
		...
		<div class="panel-body">
	        ...
	        <div class="form-group">
	          <label for="user_name">*대표자명: </label>
	          <input type="text" class="form-control" name="user_name" id="user_name">
	        </div>
	       	<div class="form-group">
	          <label for="user_id">*대표자님 아이디: </label>
	          ...
	          <input type="password" class="form-control" name="user_repw" id="user_repw">
	       	...
	       	<div class="form-group">
	          <label for="company_reg_num">사업자등록번호: </label>
	          <input type="text" class="form-control" name="company_reg_num" id="company_reg_num">
	        </div>	 	 
	       	<div class="form-group">
	          <label for="relay_reg_num">중개업소등록번호: </label>
	          <input type="text" class="form-control" name="relay_reg_num" id="relay_reg_num">
	        </div>
	       	<div class="form-group">
	          <label for="juso">사업장 주소: </label>
	          <input type="text" class="form-control" name="juso" id="juso">
	        </div>	 
	    	<div class="form-group">
